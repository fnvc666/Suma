...
//  Suma
//
//  Created by Pavel Pavel on 23/09/2025.
//
import UIKit

final class SaveChangesButton: UIView {
    ...
    private func setupUI() {
        ...
        config.attributedTitle = AttributedString("Save changes", attributes: AttributeContainer([
